        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    {!! Form::open(['route' => 'laporan.feedback.r3.index', 'class'=>'form-report no-print', 'method' => 'GET']) !!}
                    <div class="row m-b">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                {{ Form::label('month', 'Bulan', ['class' => 'col-sm-4 control-label']) }}
                                <div class="col-sm-5">
                                    {{ Form::select('month', $month_list, null , ['class' => 'form-control input-sm']) }}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <a href="{{ route('laporan.feedback.r3.index') }}"
